import{_ as e,r as t,o,c as p,a as n,d as c,F as l,b as s,e as i}from"./app.269ed0ef.js";const r={},u=n("h1",{id:"sogou-input",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#sogou-input","aria-hidden":"true"},"#"),s(" sogou input")],-1),m={href:"https://pinyin.sogou.com/linux/help.php",target:"_blank",rel:"noopener noreferrer"},b=s("sogou input"),d=s("\u3002"),k=i(`<p>Ubuntu20.04 should download the version higher than 2.3</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment"># update apt</span>
