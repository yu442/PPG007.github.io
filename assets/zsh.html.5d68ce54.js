import{_ as s,e as n}from"./app.269ed0ef.js";const a={},e=n(`<h1 id="zsh-oh-my-zsh-terminator" tabindex="-1"><a class="header-anchor" href="#zsh-oh-my-zsh-terminator" aria-hidden="true">#</a> zsh&amp;oh-my-zsh&amp;terminator</h1><p>install zsh:</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment"># install zsh</span>
